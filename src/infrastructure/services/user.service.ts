...
export class UserService {
    ...
    async createUser(email: string, password: string, firstName: string, lastName: string, country: string, city: string, address: string, postalCode: string, phone: string, avatar: string) {
